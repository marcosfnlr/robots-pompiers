 ...
 */
class Simulador implements Simulable {
     ...
     */
    public Simulador(GUISimulator gui, DonneesSimulation dados) {
        this.gui = gui;
    ...
    private void draw() {
        ...
        gui.addGraphicalElement(new Rectangle(x + 30, y     , Color.decode("#f43827"), invaderColor, 20));
